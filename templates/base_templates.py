...
<body style="margin: 0;padding: 0;font-family: Arial, sans-serif;background-color: #f2f2f2;color: #333;">
    <div class="container" style="max-width: 800px;margin: 20px auto;padding: 20px;background-color: #fff;border-radius: 5px;box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        ...
        <div class="section">
            ...
            <p class="summary" style="font-size: 18px;margin-bottom: 10px;">Tempo de sopradora em falha nas últimas 24 horas: <strong>{fault_time}</strong></p>
        ...
        <div class="section">
            <div class="graph-container" style="display: flex;justify-content: space-between;margin-bottom: 5px;">
    ...
    <div style="background-color: #f2f2f2; padding: 20px; border-radius: 5px;margin-left:2px">
        ...
        <div class="section">
            ...
            <p><strong>A eficiência do seu equipamento foi calculada com base no tempo da máquina soprando e na velocidade média. A eficiência é expressa como a porcentagem da produção total em relação à produção esperada durante o mesmo período de tempo.</strong></p>
            ...
            <br>
            <p><strong>Para resultados mais precisos e detalhados acesse a plataforma multipetcloud.com.br com seu usuário e senha.</strong></p>
...
HTML_TEMPLATE_GRAFICOS = """<!DOCTYPE html>
<html lang="pt-br" style="margin: 0;padding: 0;box-sizing: border-box;">
    ...
    <div style="background-color: #f2f2f2; padding: 20px; border-radius: 5px;margin-left:2px">
        ...
        <div class="section">
            <div class="graph-container" style="display: flex;justify-content: space-between;margin-bottom: 20px;">
                <div style="background-color: #f2f2f2; padding: 20px; border-radius: 5px;margin-left:2px">
                    <img src="cid:image3" alt="Tempo Produzindo" class="graph" style="max-width: 100%;height: auto;">
                    <p style="text-align: center; font-size: 16px; color: #666;">Tempo alimentando e produzindo</p> 
    
                </div>
                <div style="background-color: #f2f2f2; padding: 20px; border-radius: 5px;margin-left:2px">
                    <img src="cid:image4" alt="Tempo Produzindo" class="graph" style="max-width: 100%;height: auto;">
                    <p style="text-align: center; font-size: 16px; color: #666;">Temperatura da Coifa</p> 
